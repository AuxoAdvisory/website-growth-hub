        ...
        <div className="space-y-3">
          {timeline.map((t, i) => (
            <FadeIn key={t.title} delay={i * 0.08}>
              <div className="rounded-lg border border-border bg-card p-5 flex gap-4 items-start shadow-sm hover:border-accent/30 hover:shadow-[0_4px_24px_-8px_hsl(226_100%_71%_/_0.1)] transition-all duration-300 group">
