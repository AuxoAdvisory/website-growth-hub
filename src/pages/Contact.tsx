    ...
    <Layout>
      <section className="bg-hero text-hero-foreground section-padding">
        <div className="container-narrow max-w-3xl mx-auto">
          <FadeIn>
            <h1 className="font-display font-extrabold text-4xl md:text-5xl">Let's talk</h1>
            <p className="mt-5 text-hero-muted text-lg">No sales pitch. Just a straightforward conversation about whether we can help.</p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container-narrow max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          <FadeIn>
            <div className="rounded-2xl border border-border bg-secondary p-8 flex flex-col items-center justify-center min-h-[400px] text-center">
              ...
              <h3 className="font-display font-bold text-xl text-foreground">Pick a time</h3>
          ...
          <FadeIn delay={0.15}>
            <form onSubmit={handleSubmit} className="space-y-5">
              <h3 className="font-display font-bold text-xl text-foreground">Or drop us a message</h3>
              <div>
              ...
              <div>
                ...
                <Input id="email" type="email" placeholder="you@business.com" required className="mt-1" />
              </div>
              <div>
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Tell us a bit about your business..." rows={4} className="mt-1" />
              </div>
