...
const painPoints = [
  { icon: Star, title: "Low Google reviews", desc: "Your competitors have hundreds of reviews. You have a handful. Customers choose them before they even see your website." },
  { icon: Globe, title: "Slow website losing patients", desc: "If your site takes more than 3 seconds to load on mobile, you're losing clients to the business down the street." },
  { icon: AlertTriangle, title: "No online booking", desc: "Customers want to book at 10pm on a Tuesday. If they can't, they'll find someone who lets them." },
];
    ...
    <div className="container-narrow">
      <FadeIn>
        <div className="text-center mb-14">
          <p className="text-[11px] font-medium text-accent mb-4 tracking-[0.2em] uppercase font-mono">The problem</p>
