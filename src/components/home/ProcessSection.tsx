...
const steps = [
  { icon: Search, time: "Week 1", title: "Audit", desc: "We audit your Google profile, website, and missed call rate.", num: "01" },
  { icon: Rocket, time: "Weeks 2–3", title: "Deploy", desc: "We set up your AI chatbot, review automation, and SMS follow-up system.", num: "02" },
  { icon: TrendingUp, time: "Month 2+", title: "Grow", desc: "You start getting more leads, reviews, and bookings on autopilot.", num: "03" },
];
        ...
        {steps.map((step, i) => (
          <FadeIn key={step.title} delay={i * 0.1}>
            <div className="relative flex flex-col items-center text-center">
              <div className="w-14 h-14 rounded-md border border-border bg-card flex items-center justify-center relative z-10 mb-5 shadow-sm">
        ...
        {steps.map((step, i) => (
          <FadeIn key={step.title} delay={i * 0.08}>
            <div className="relative mb-6 last:mb-0">
              <div className="absolute -left-12 top-0 w-9 h-9 rounded-md border border-border bg-card flex items-center justify-center z-10 shadow-sm">
