...
const GreyStar = () => <span style={{ color: "#3A3A4A" }}>★</span>;

const BeforeAfterCard = () => (
  <div className="rounded-xl border border-border bg-card p-7">
    <div className="grid grid-cols-2 gap-0">
      {/* Before */}
      <div className="pr-6 border-r border-border rounded-l-lg" style={{ background: "#0D0D14" }}>
        <div className="p-1">
      ...
      {/* After */}
      <div className="pl-6 rounded-r-lg" style={{ background: "#0F1623" }}>
        <div className="p-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-7 pb-[60px]">
          <FadeIn>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center mt-9 h-[52px] px-9 text-[16px] font-semibold rounded-md transition-colors duration-200"
